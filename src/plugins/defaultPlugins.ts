...
import BankMarketPlugin from '#/plugins/BankMarketPlugin.js';
...
import RemoveRoofsPlugin from '#/plugins/RemoveRoofsPlugin.js';
...
export function createDefaultPlugins(): ClientPlugin[] {
    return [new ExtendedInactivityTimerPlugin(), new ExtendedCameraZoomPlugin(), new BankMarketPlugin(), new TrueTilePlugin(), new MenuEntrySwapperPlugin(), new PickpocketLeftClickPlugin(), new RemoveRoofsPlugin(), new ShopLeftClickPlugin(), new KeyRemappingPlugin()];
}
